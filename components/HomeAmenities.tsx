...
const amenities: Amenity[] = [
  ...
  { icon: Shield, title: "Fully Legal & Secure", description: "Operating under proper licensing in Noida, with monitored premises, professional security, and complete peace of mind." },
